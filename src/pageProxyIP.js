...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .github-corner svg{fill:rgba(255,255,255,.9);color:var(--primary-color);width:80px;height:80px}
    ...
    @media(max-width:768px){.container{padding:16px}.card{padding:24px}.input-group{flex-direction:column}.input-wrapper{min-width:auto}.btn{width:100%}.github-corner svg{width:60px;height:60px}}
  </style>
</head>
<body>
  ${tokenBadge}
...
&nbsp;&nbsp;"timestamp": "2025-06-03T17:27:52.946Z"<br>
    ...
    <div class="footer">
      <p style="margin-top:8px;opacity:.8">© 2025 Check ProxyIP + Socks5/HTTP - 基于 Cloudflare Workers 构建的高性能代理验证服务 | 由 <strong>cmliu</strong> 开发</p>
      ${footerToken}
    </div>
  </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (!autoCheck) {
        ...
        if (checkSeg && isValidProxyIPFormat(checkSeg)) autoCheck = checkSeg;
      }
      if (!autoCheck) {
