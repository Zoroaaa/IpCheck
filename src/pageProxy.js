...
export function renderProxyPage(ico, beian, bgStyle, pathToken) {
...
.github-corner svg{fill:#53b156;color:#fff;position:fixed;top:0;right:0;border:0;width:80px;height:80px}
